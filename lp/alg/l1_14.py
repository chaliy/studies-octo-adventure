# 15.	На стрічці машини Поста знаходяться n масивів міток. 
# Каретка знаходиться десь над першим масивом. Видалити всі 
# парні масиви, якщо всі масиви розділені трьома порожніми секціями.
